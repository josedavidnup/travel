    ...
    <>
      ...
      <section className="w-full h-auto">
        <div id="home">
          <div className="w-full h-3/4">
            <div className="w-full h-full flex flex-col absolute space-y-96 py-4 items-center ">
              <input
                className="outline-none p-3 rounded-full shadow-sm transition duration-300 focus-within:shadow-sm focus:ring-2 focus:w-11/12"
                placeholder="San Francisco"
                type="search"
              />
              <button className="w-48 rounded-full text-lg text-primary shadow-sm font-semibold p-4 bg-white transition-all duration-500 ease-in-out hover:bg-primary hover:text-white transform hover:translate-y-1 hover:scale-110">
                Explore
              </button>
            </div>
          ...
          <div className="w-auto h-72 items-center mt-6 overflow-x-auto overscroll-x-contain flex space-x-6 overflow-y-hidden">
            ...
            <div className="card">
              ...
              <div className="w-full h-2/5 bg-white rounded-b-lg">
                <p className="text-terciary text-bold text-xl px-4 py-2">
                  New York
                </p>
                <p className="text-terciary text-md px-4">Concrete jungle</p>
              </div>
            </div>
            <div className="card">
              <div className="w-full h-3/5 rounded-t-lg bg-new_york bg-cover "></div>
        ...
        <div className="px-2 h-auto w-full" id="rentas_destacadas">
          <div>
            <p className="text-3xl text-primary font-semibold pb-6 pt-2 mt-6">
              Rentas Destacadas
            </p>
            <div className="w-full h-full flex flex-col space-y-6 items-center justify-center">
              <div className="w-full h-96 bg-red-200 bg-chicago bg-cover rounded-xl ">
                <p className="card-title">Chicago</p>
                <p className="text-sm pl-8 text-white mr-24">
                  2 habitaciones, baño y cocina
                </p>
              </div>
              <div className="w-full h-96 bg-red-200 bg-LA bg-cover rounded-xl ">
                <p className="card-title">Los Angeles</p>
                <p className="text-sm pl-8 text-white mr-24">
                  2 habitaciones, baño y cocina
                </p>
              </div>
              <div className="w-full h-96 bg-red-200 bg-miami bg-cover rounded-xl ">
                <p className="card-title">Miami</p>
                <p className="text-sm pl-8 text-white mr-24">
                  2 habitaciones, baño y cocina
                </p>
              </div>
              <div className="w-full h-96 bg-red-200 bg-bali bg-cover rounded-xl ">
        ...
        <div className="w-full h-full" id="faqs">
          <div className="w-full h-full px-6 flex flex-col space-y-4">
            ...
            <div>
              <p class="text-xl font-medium text-primary">Métodos de pago</p>
              <p class="text-md pt-2">
            ...
            <div>
              <p class="text-xl font-medium text-primary">Mascotas</p>
              <p class="text-md pt-2">
            ...
            <div>
              <p class="text-xl font-medium text-primary">Estancias Largas</p>
              <p class="text-md pt-2">
      ...
      <footer className="w-full h-auto bg-gray-50 p-6 space-y-2">
        ...
        <p className="text-sm text-gray-400">Investing</p>
        <p className="text-sm text-gray-400">Work with us</p>
        ...
        <i className="fa-brands fa-instagram text-purple-400 ml-1"></i>
      </footer>
      <div
        className="w-full h-16 bg-white fixed left-0 bottom-0 shadow-md flex items-center justify-around"
        id="tab_bar"
      >
        <a href="#home">
